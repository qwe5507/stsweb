...
<!-- 										<span class="info">8-16자:영문,숫자조합</span> -->
										<input type="text" class=" placeholder" placeholder="4-20자: 영문 소문자,숫자조합" name="userId" title="아이디를 입력하세요" autocomplete='new-password'>
									</p>
								...
								<li>
									...
									<p class="form">
										...
										<input type="password" name="userPass" class=" placeholder" placeholder="6-20자:영문,숫자,특수문자조합" title="비밀번호를 입력하세요" autocomplete='new-password'>
									</p>
								</li>
								<li>
									...
									<p class="form">
										<!--  <span class="info">6-20자:영문,숫자,특수문자조합</span> -->
										<input type="password" name="userPassCk" class=" placeholder" placeholder="6-20자:영문,숫자,특수문자조합" title="비밀번호를 입력하세요" autocomplete='new-password'>
									</p>
								</li>
								<li>
									<p class="tit">이름</p>
									<p class="form">
										<input type="text" name="userName" title="이름을 입력하세요" autocomplete='new-password'>
									</p>
								</li>
								<li>
									<p class="tit">휴대전화</p>
								...
								<li>
									<p class="size">신체 정보</p>
									<p class="form">
										<label>키<input type="text" maxlength="3" name="userHeight" title="키" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></label>
										<label>몸무게<input type="text" maxlength="3" name="userWeight" title="몸무게" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></label>
									</p>
								</li>
								<li>
									<p class="tit">생일</p>
