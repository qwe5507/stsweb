			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto h-100">
					...
					<li class="nav-item"><a class="nav-link active"
						href="products.do"> <i class="fas fa-shopping-cart"></i>
							Products
					</a></li>
							...
							<div class="col-xl-6 col-lg-6 col-md-12">
								...
								<div class="form-group mb-3">
									<label for="ca_smallcate">카테고리 - 소분류</label> <select
										class="custom-select tm-select-accounts form-control"
										id="ca_smallcate" name = "ca_smallcate">
...
<!-- 										onclick="document.getElementById('mainfile').click();"></i> -->
								...
								<div class="custom-file mt-3 mb-3 col-sm-12 ">
									<input id="mainfile" type="file" name="mainfile"
										class="form-control validate" style = "display : none; "/> <input type="button"
								...
								<div class="custom-file mt-3 mb-3 col-sm-12" >
									<input id="subfileInput" multiple="multiple" type="file"
										name="subfileInput" class="form-control"  style = "display : none;" /> <input
							...
							<div class="form-group mb-12 col-xs-12 col-sm-12"
								...
								<textarea class="form-control validate" rows="6"
									name="p_content" id="p_content" required></textarea>
							</div>

							<div class="col-12">
								<button type="button"
									class="btn btn-primary btn-block text-uppercase" id = "productinsert">상품 등록</button>
							</div>
						</div>
					</form>
				</div>
